package com.fbc0928.dysms.service;
...
public class SmsUtil {
    ...
    @Value("${accessKeyId}")
    public static String accessKeyId = "LTAIp96fRQOZEkdb";
    @Value("${accessKeySecret}")
    private static String accessKeySecret = "qFMPQHLCFbAzNAgVYMj0MS3ZbdXZ4A";
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //发短信
        SendSmsResponse response = sendSms("18137843733","王银珂粉丝团","SMS_163625244","");
        ...
        if(response.getCode() != null && response.getCode().equals("OK")) {
            QuerySendDetailsResponse querySendDetailsResponse = querySendDetails("18137843733",response.getBizId());
    ...
    public static void sendMessage(Map<String, String> map) {
        try {
            SendSmsResponse response = sendSms(map.get("mobile"),
                    map.get("signName"),
